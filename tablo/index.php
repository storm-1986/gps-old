...
if (isset($_GET['exit'])){
	...
	if(!isset($_POST['vybor'])&&!isset($_COOKIE['type'])){
		...
		if (isset($_COOKIE['w1']) && $_COOKIE['w1'] > ''){
			$w1 = $_COOKIE['w1'];
		}else{
			$w1 = $_POST['sel1_'.$type];	
			setcookie('w1', $w1, time()+2678400);
		}
		if (isset($_COOKIE['w2']) && $_COOKIE['w2'] > ''){
			$w2 = $_COOKIE['w2'];
		}else{
			$w2 = $_POST['sel2_'.$type];	
			setcookie('w2', $w2, time()+2678400);
		}
		if (isset($_COOKIE['w3']) && $_COOKIE['w3'] > ''){
			$w3 = $_COOKIE['w3'];
		}else{
			$w3 = $_POST['sel3_'.$type];
			setcookie('w3', $w3, time()+2678400);
		}
		// if (isset($_COOKIE['w4']) && $_COOKIE['w4'] > ''){
		// 	$w4 = $_COOKIE['w4'];
		// }else{
		// 	$w4 = $_POST['sel4_'.$type];
	...
	<!--	Для 2 экранов	-->
		<div class="var">
			...
			<table id="tbl_var1" border="1" cellpadding="10px" style="margin: 10px 0px;">
				<tr>
				<td><select name="sel1_1" id="sel1_1" style="cursor: pointer;"><?php include "list1.php";?></select></td>
				<td><select name="sel2_1" id="sel2_1" style="cursor: pointer;"><?php include "list2.php";?></select></td>
				</tr>
			</table>
		</div>
		<div class="var">
			...
			<table id="tbl_var1" border="1" cellpadding="10px" style="margin-bottom: 10px;">
				<tr>
				<td><select name="sel1_2" id="sel1_2" style="cursor: pointer;"><?php include "list1.php";?></select></td>
				<td><select name="sel2_2" id="sel2_2" style="cursor: pointer;"><?php include "list3.php";?></select></td>
				</tr>
				<tr>
				<td colspan="2"><select name="sel3_2" id="sel3_2" style="cursor: pointer;"><?php include "list2.php";?></select></td>
				</tr>
			</table>
		</div>
		<div class="var">
			...
			<table id="tbl_var1" border="1" cellpadding="10px" style="margin-bottom: 10px;">
				<tr>
				<td colspan="2"><select name="sel1_3" id="sel1_3" style="cursor: pointer;"><?php include "list2.php";?></select></td>
				</tr>
				<tr>
				<td><select name="sel2_3" id="sel2_3" style="cursor: pointer;"><?php include "list1.php";?></select></td>
				<td><select name="sel3_3" id="sel3_3" style="cursor: pointer;"><?php include "list3.php";?></select></td>
				</tr>
			</table>
		</div>
		<div class="var">
			...
			<table id="tbl_var1" border="1" cellpadding="10px" style="margin-bottom: 10px;">
				<tr>
				<td rowspan="2"><select name="sel1_4" id="sel1_4" style="cursor: pointer;"><?php include "list2.php";?></select></td><td><select name="sel2_4" id="sel2_4" style="cursor: pointer;"><?php include "list1.php";?></select></td>
				</tr>
				<tr>
				<td><select name="sel3_4" id="sel3_4" style="cursor: pointer;"><?php include "list3.php";?></select></td>
				</tr>
			</table>
		</div>
		<div class="var">
			...
			<table id="tbl_var1" border="1" cellpadding="10px" style="margin-bottom: 10px;">
				<tr>
				<td><select name="sel1_5" id="sel1_5" style="cursor: pointer;"><?php include "list1.php";?></select></td><td rowspan="2"><select name="sel2_5" id="sel2_5" style="cursor: pointer;"><?php include "list2.php";?></select></td>
				</tr>
				<tr>
				<td><select name="sel3_5" id="sel3_5" style="cursor: pointer;"><?php include "list3.php";?></select></td>
				</tr>
			</table>
		</div>
		<div class="var">
			...
			<table id="tbl_var1" border="1" cellpadding="10px" style="margin-bottom: 10px;">
				<tr>
				<td><select name="sel1_6" id="sel1_6" style="cursor: pointer;"><?php include "list1.php";?></select></td><td><select name="sel2_6" id="sel2_6" style="cursor: pointer;"><?php include "list2.php";?></select></td>
				</tr>
				<tr>
				<td><select name="sel3_6" id="sel3_6" style="cursor: pointer;"><?php include "list3.php";?></select></td><td><select name="sel4_6" id="sel4_6" style="cursor: pointer;"><?php include "list4.php";?></select></td>
				</tr>
			</table>
		</div>
...
*/
	?>
	<frameset cols="50%,50%">
		<frame src="<?php echo $adr1;?>" name="<?php echo $w1;?>" <?php echo $scroll1;?>>
		<frame src="<?php echo $adr2;?>" name="<?php echo $w2;?>" <?php echo $scroll2;?>>
	</frameset>	
	<?php
	/*
	}elseif($type == 2){
	...
	<frameset cols="50%,50%">
		...
		<frame src="<?php echo $adr3;?>" name="<?php echo $w3;?>" <?php echo $scroll3;?>>
	</frameset>
	<?php	
	}elseif($type == 3){
	?>
	...
	<frameset rows="50%,50%">   
		<frame src="<?php echo $adr2;?>" name="<?php echo $w2;?>" <?php echo $scroll2;?>>
		<frame src="<?php echo $adr4;?>" name="<?php echo $w4;?>" <?php echo $scroll4;?>>
	</frameset>
	</frameset>
	<?php	
	}
